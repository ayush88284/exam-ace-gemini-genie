...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ contentSource }) => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const aiResponse = {
        ...
        content: `This is a simulated response to "${inputMessage}". In a real implementation, this would be generated by Gemini API based on your study material.`,
        isUser: false,
      };
